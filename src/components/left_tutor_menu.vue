...
const activeMenu = ref('MyStudents')
  ...
  <div class="leftpartpage">
    <div class="leftmenu">
      ...
      <div class="menu">
        <button 
          class="menu_button" 
          :class="{ active: activeMenu === 'MyStudents' }"
          @click="switchComponent('MyStudents')"
        >
          Мои ученики
        </button>
        ...
        <button 
          class="menu_button" 
          :class="{ active: activeMenu === 'TutorNotification' }"
          @click="switchComponent('TutorNotification')"
        >
          Уведомления
        </button>
        <a 
