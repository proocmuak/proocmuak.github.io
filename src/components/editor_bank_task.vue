    ...
    <div class="editor-form" v-if="selectedSubject">
      ...
      <div class="text-editor">
        ...
        <div class="editor-toolbar">
          <button @click="insertTable" class="toolbar-button" title="Вставить таблицу">
            <i class="table-icon">📊</i>
          </button>
          <button @click="insertSubscript" class="toolbar-button" title="Нижний индекс">
            <i>x<sub>2</sub></i>
          </button>
        </div>
        <textarea 
  ...
  methods: {
    ...
    insertTableToText() {
      ...
      if (this.editingTable) {
        this.newTask.text = 
          this.newTask.text.substring(0, startPos) + 
          html + 
          this.newTask.text.substring(endPos);
      } else {
        this.newTask.text = 
          this.newTask.text.substring(0, startPos) + 
          html + 
          this.newTask.text.substring(startPos);
      }
