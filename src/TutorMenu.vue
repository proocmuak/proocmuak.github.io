...
const components = {
  main_tutor_page: markRaw(main_tutor_page),
  settings: markRaw(settings),
  editor_bank_task: markRaw(editor_bank_task),
  MyStudents: markRaw(MyStudents),
  TutorTaskBank: markRaw(TutorTaskBank),
  TutorNotification: markRaw(TutorNotification)
}
...
export default{
    ...
    data() {
        return {
            currentComponent: components.MyStudents,
            loading: true,
            componentProps: {},
            isTutor: false,
            error: null,
    ...
    methods: {
        setCurrentComponent(componentName) {
            const component = this.componentMap[componentName] || components.MyStudents;
