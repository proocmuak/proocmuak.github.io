<template>
    <div class="go_back"> <a href="../student_menu.html">Вернуться на главный экран</a>  </div>
  <div class="chemistry-container">
    <CalendarChemistryEge 
...
<script setup>
import { ref } from 'vue'
import CalendarChemistryEge from './components/calendar_chemistry_ege.vue'
import LessonChemistryEge from './components/lesson.vue'
